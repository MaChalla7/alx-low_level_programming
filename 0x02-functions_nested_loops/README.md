0x02. C - Functions, nested loops alx project done during the full stack engineering foundation phase. 0. _putchar | Write a program that prints _putchar, followed by a new line.
